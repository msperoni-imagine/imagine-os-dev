...
export default function EmpresaGrupoDetalleError({
  error,
  reset,
}: {
    ...
    <div className="flex flex-col items-center justify-center py-20">
      <div className="rounded-xl bg-white p-8 shadow-sm text-center max-w-md">
        ...
        <h2 className="mt-4 text-lg font-bold text-foreground">
          Error al cargar la empresa de grupo
        </h2>
        <p className="mt-2 text-sm text-muted-foreground">
          {error.message || 'No se pudo cargar el detalle de la empresa de grupo.'}
        </p>
